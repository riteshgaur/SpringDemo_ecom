...
<div class="container-wrapper">
    <div class="container">
        ...
        <div class="form-group">
            ...
            <form:input path="instock" id="instock" class="form-Control" value="${product.instock}"/>
        </div>

        <div class="form-group">
            <label for="manufacturer">Manufacturer</label>
            <form:input path="manufacturer" id="manufacturer" class="form-Control" vaule="${product.manufacturer}"/>
        </div>
